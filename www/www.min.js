...
return {
  scanQRCode: function(allow) {
    cordova.exec(null, null, 'QRScanner', 'allowQRCode', [allow]);
  },
  scanBarcode: function(allow) {
    cordova.exec(null, null, 'QRScanner', 'allowBarcode', [allow]);
  },
